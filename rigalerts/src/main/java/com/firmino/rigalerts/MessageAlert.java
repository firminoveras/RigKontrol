...
public class MessageAlert {
    ...
    public static void create(Context context, int messageType, String message) {
        View toastContent = ((Activity) context).getLayoutInflater().inflate(R.layout.toast_layout, ((Activity) context).findViewById(R.id.Toast_Main));
